$(document).ready(function () {
  ...
  function weatherAPI(searchTerm) {
      $.ajax({
          method: "GET",
          url: "https://api.openweathermap.org/data/2.5/weather?q=" + searchTerm + "&appid=66fa9b97478bf2b9d156815cabfc54c0&units=imperial",
  ...
  function forecast(searchTerm) {
      $.ajax({
          method: "GET",
          url: "http://api.openweathermap.org/data/2.5/forecast?q=" + searchTerm + "&appid=7ba67ac190f85fdba2e2dc6b9d32e93c&units=imperial",
      }).then(function (response) {
        ...
        //creating the icon image with jquery
                  const img = $("<img>").attr("src", "http://openweathermap.org/img/w/" + icon + ".png");
